...
<form id="myForm" class="form-horizontal"
    ...
    <div class="row">
      ...
      <div class="col-md-8 offset-md-1" >
          <center><h2 class="blue-text">Online Application</h2></center>
               ...
               <?php
                foreach( $columns as $key => $value ) {
                  ...
                  if( in_array($key, $columns_not_allowed ) === false ) {
                    $draw_line = in_array($key, $field_sep ) ? 'draw_ln' : '';
                    if($key == 'phone'){
                        $place_holder = "Example: Restaurant/Tavern, Sports Bar, Nite Club";
                        $line_title = "Insured By";
                    }
                    if($key == 'type_operation'){
                        $place_holder = "Example: Restaurant/Tavern, Sports Bar, Nite Club";
                        $line_title = "Property Coverage";
                    }
                        
                    if($key == 'type_entertainment'){
                       $place_holder = "Example: Bands, Karaoke, Disc Jockey";
                       $line_title = "Workers Compensation";
                    }
