...
?>
	...
	<div id="banner-area" class="banner-area" style="background-image:url(public/images/jkingsley/homepage_restaurant.jpg)">
		<!-- Subpage title start -->
	        	...
	        	<div class="row">
	        		<div class="col-xs-12">
	        			<div class="banner-heading">
	        				<h1 class="banner-title">Restaurant Insurance</h1>
	        			</div>
			        	<ul class="breadcrumb">
			            <li>Home</li>
